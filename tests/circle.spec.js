...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    const circleP = circle(1);
    
    expect(Object.keys(circleP).length).toBe(3);
    ...
    // Teste se dentro do objeto retornado, a função retorna uma `key` com `value`
    //igual à circunferência correta para um círculo de raio 2.
    
    expect(circle(2)).toHaveProperty('circumference', 12.56);
    

    // Teste se dentro do objeto retornado, a função retorna uma `key` com `value` 
    //igual à área correta para um círculo de raio 3.
    
    expect(circle(3)).toHaveProperty('area', 28.259999999999998);


    // Teste se a função retorna, em um objeto, os dados corretos 
